...
| **NEEDS OWNER DECISION** | Coupon priority, service refund eligibility, audit cure duration, Preferred billing grace duration (7-day default), production scheduler cadence |
