...
The settled registration boundary requires public Creator name, slug, short bio, and optional profile media, plus private legal/business/contact/address data, Agreement acceptance, rights confirmation, complete Connect readiness, payment-method readiness, and active identity entitlement. Creator registration must be fully complete before product intake or listing tools become available, including drafts and Free or PWYW intake. Stripe owns sensitive payment, identity, KYC, tax, and bank data. Product declarations concern rights, accurate representation, licenses/attributions, technical safety, delivery integrity, and marketplace compliance. They contain no AI-use disclosure.
